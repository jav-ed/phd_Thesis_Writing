...
In the previous @chap_1_2, it was observed that the automotive industry offers significant advancements in hydrogen-driven vehicles. Furthermore, this industry contributes a considerable amount of literature and expertise to the field. The previous @chap_1_2 also highlighted substantial similarities between the hydrogen-driven automotive industry and aerospace. Both fields desire lightweight #gls("cfrp", long:true) tanks to store, among other things, #gls("cgh2", long:true). Due to the value the automotive industry provides to the realization of #gls("swith", long:true), an in-depth study shall be carried out.
