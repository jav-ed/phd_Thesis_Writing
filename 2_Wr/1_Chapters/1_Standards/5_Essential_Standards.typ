...
The analysis focuses on two key aspects: the safety factors prescribed for the burst test and the maximum allowable nominal pressures. These parameters, derived from the findings, are critically evaluated to assess their implications for #gls("swith") certification.
...
It is important to note that test names alone furnish insufficient information about the specific testing procedures. A comparative analysis of various standards revealed that tests with similar nomenclature often entail significantly different methodologies and requirements.
Despite this limitation, these tables serve a valuable purpose by providing an overview of the types of tests potentially necessary for #glspl("swith") certification. 
They offer a general indication of the range and nature of tests that developers and manufacturers should anticipate. It is crucial to recognize that the classification of tests as mandatory or optional may vary depending on the specific circumstances of each project. Some tests listed as optional may become mandatory based on particular design features, intended use, or regulatory requirements of the #gls("swith") in question.

While the aforementioned standards primarily focus on hydrogen containment systems, it is important to acknowledge that #glspl("swith") must also comply with broader aircraft regulations. This imperative led to the inclusion of #gls("cs")-23 @EASA_CS_23 and #gls("cs")-25 @EASA_CS_25 in the list of essential standards in @tab_11.
Among these, as explained in @chap_1_1, #gls("cs")-23 is limited to small aircraft, whereas #gls("cs")-25 stands as the more comprehensive version that also covers larger aircraft. 
