...
Returning to EC 406/2010, beyond the aforementioned language specifications, studying the EC 406/2010 reveals that it lacks any direct references to aircraft applications. Furthermore, EC 406/2010 specifies additional potential limitations, particularly in its testing requirements. These requirements may exceed available economic resources, as they stipulate that multiple #glspl("swith") specimens must undergo a single experimental test.
This demand for multiple specimens is not unique to EC 406/2010 but is also appears in ISO 11119-3:2020 @11119_3_ISO. A notable example is found in ISO-11119-3, paragraph 8.2.1, which explicitly states: #emp_[A minimum of 30 cylinders of the new design shall be made available for prototype testing]. 
