...
In previous @chap_1_4, an overview of standards from various areas using #gls("cgh2", long:true) as fuel was presented. Building upon this list of options, this section aims to summarize the overarching categories of hydrogen applications and clearly identify the category in which #gls("swith", long:true) is classified.
