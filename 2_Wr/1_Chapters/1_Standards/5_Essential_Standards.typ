...
To lay out a structured overview of potential tests that #glspl("swith") might undergo, selected information from the chosen essential standards is presented. A list of the mandatory and optional tests, as outlined in ISO 11119-3:2020, appears in @tab_12 and @tab_13, respectively. These tables offer a concise summary of the testing requirements, distinguishing between tests that are universally required and those that may be necessary under specific circumstances.
