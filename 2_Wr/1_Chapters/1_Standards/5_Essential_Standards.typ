...
It is important to acknowledge that in other geographical or political settings, different regional frameworks might take precedence. The choice of regional focus should be determined by the specific context of the research, the regulatory environment in which #glspl("swith") are being developed and implemented, and the broader goals of the project. While this thesis gives precedence to European standards, the principles of standard selection elaborated here can be applied to other regional or international frameworks as appropriate.

The cost of acquisition plays a decisive role, particularly for start-ups and small to medium-sized research and industrial institutions. These entities often operate under constrained budgets, making affordability a key factor in standard selection.
The coverage of #glspl("swith") requirements is a crucial criterion. It is generally understood that any standard failing to account for this aspect would be automatically disqualified from assessment. This criterion acts as a fundamental filter, ensuring that only relevant standards are included in the selection process.
...
Returning to EC 406/2010, beyond the aforementioned language specifications, studying the EC 406/2010 reveals that it lacks any direct references to aircraft applications. Additionally, EC 406/2010 specifies additional potential limitations, particularly in its testing requirements. These requirements may exceed available economic resources, as they stipulate that multiple #glspl("swith") specimens must undergo a single experimental test.
This demand for multiple specimens is not unique to EC 406/2010, but it also appears in ISO 11119-3:2020 @11119_3_ISO. A notable example is found in ISO-11119-3, paragraph 8.2.1, which explicitly states: #emp_[A minimum of 30 cylinders of the new design shall be made available for prototype testing]. 
...
Another obstacle to the direct applicability of EC 406/2010 to #glspl("swith") stems from certain prescribed demands that may be considered excessively stringent. These requirements, found identically in both EC 406/2010 and ISO 19881:2018, relate to the gaseous hydrogen burst ratio criteria. In particular, these criteria are delineated in section 3.6 of EC 406/2010 and section 7.3.2 of ISO 19881:2018.
...
To lay out a structured overview of potential tests that #glspl("swith") might undergo, selected information from the chosen essential standards is presented. A list of the mandatory and optional tests, as outlined in ISO 11119-3:2020, appears in @tab_12 and @tab_13, respectively. These tables offer a concise summary of the testing requirements, distinguishing between tests that are universally mandatory and those that may be warranted under specific circumstances.
...
The presentation of these tables, which primarily list test names, does not raise copyright concerns due to their limited content. It is important to note, however, that test names alone furnish insufficient information about the specific testing procedures. A comparative analysis of various standards revealed that tests with similar nomenclature often entail significantly different methodologies and requirements.
Despite this limitation, these tables serve a valuable purpose by offering an overview of the types of tests potentially necessary for #glspl("swith") certification. They offer a general indication of the range and nature of tests that developers and manufacturers should anticipate. It is crucial to recognize that the classification of tests as mandatory or optional may vary depending on the specific circumstances of each project. Some tests listed as optional may become mandatory based on particular design features, intended use, or regulatory requirements of the #gls("swith") in question.

While the aforementioned standards primarily focus on hydrogen containment systems, it is important to recognize that #glspl("swith") must also comply with broader aircraft regulations. This imperative led to the inclusion of #gls("cs")-23 @EASA_CS_23 and #gls("cs")-25 @EASA_CS_25 in the list of essential standards in @tab_11.
Among these #gls("cs")-23 is limited to small aircraft, whereas #gls("cs")-25 stands as the more comprehensive version that also covers larger aircraft.

#summary_([
From the numerous available standards, the introduced assessment criteria were used to obtain a few essential standards in a structured manner. The analysis has identified four essential standards pertinent to the development and certification of #glspl("swith"). While these standards collectively do not address all the unique aspects of #glspl("swith"), they represent the current state of the art in relevant regulatory frameworks. They provide valuable insights into potential certification requirements and testing protocols for #glspl("swith").
