...
Depending on the literature consulted, different definitions of the term #emp_[standard] can be found @Tassey2000 @Nickerson2006 @Farrell1992 @Anderson1990 @Murmann2006.
...
The contribution of experts to the composition and revision of standards ensures that aspects an individual might not consider are addressed, thereby enhancing the safety and reliability of products and systems.
...
For the purpose of designing and conducting experimental structural validation tests of a #gls("swith") safely, standards can be assumed to provide critical guidelines.
...
Furthermore, the shared framework also promotes compatibility and interoperability between different components and systems, which is significant for these complex systems @Narayanan2012.
...
As an emerging technology, there is no single standard that covers all the unique characteristics of #glspl("swith"). 
This absence, however, does not diminish the importance of standards-based approaches. 
...
Regardless of the initial focus, as #glspl("swith") advance, standards may expand to cover areas such as manufacturing processes, maintenance procedures, and operational guidelines for hydrogen-powered aircraft.
...
At the time of writing this thesis, there are no known standards or regulations that can be applied for obtaining certification for #glspl("swith"). This lack of an available certification procedure severely limits the industrial and scientific employment of #glspl("swith"). 
As a result, there is a clear demand for proper standards upon which industry and scientific institutions can build.
