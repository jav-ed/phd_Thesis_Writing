...
== Classification and Analysis of Hydrogen Pressure Vessels <chap_1_2>

Besides aviation, according to @chap_1_0, one of the other main domains into which #glspl("swith") can be divided is the domain of pressure vessels. Following this, this section will first provide general basics about pressure tanks. 
...
Linking back to industry standards, specific guidelines for pressure vessels are addressed in @chap_1_4.

// -------------------------------------------------------------------------- //
The primary objective is to identify information that could enhance the state of the art for certifying #glspl("swith"). As motivated in @chap_1_0, this shall be achieved through commercially available standards. Pressure tanks can be regarded as the second major sub-area into which #glspl("swith") can be categorized. These specialized containers are designed to safely store and deliver compressed gases under high pressure.
The literature and patents reveal various pressure vessel geometries @Rosen2018 @blair2015composite @Jaber2024 @aceves2006advanced @Yersak2019 @Geuskens2011. One of the main motivations for developing conformable pressure vessels is to improve space utilization @aceves2006advanced. 
...
While the aerospace industry is renowned for its emphasis on lightweight structures @Khan2024 @Chen2023 @Acanfora2023 @Okorie2023 @Seo2023, it also grapples with limited free space. Despite the substantial size of commercial aircraft, space remains a critical factor due to some of the economic demands of civil aviation. Increased available space translates to either more paying passengers or additional cargo capacity. As a concrete example, conformable pressure vessels could be utilized to design structurally efficient pressure cabins for blended wing-body aircraft @Geuskens2011.
...
While conformable pressure vessels can have various shapes, a demonstrative example is depicted in @fig_10.
...
Aluminum tanks emerged as an alternative to steel, offering improved resistance to embrittlement, but at a markedly higher cost. 
To address the weight issues associated with steel bottles, engineers developed partial to complete composite wrapping techniques. This innovation led to substantial weight reductions, enabling the use of these pressure vessels in mobile applications @Jaber2024 @Rivard2019 @khzouz2020hydrogen @Elberry2021.
The next crucial development involved replacing metallic liners with plastic ones @Wang2021b @Jella2024 @Cheng2024. In this design, composite winding encases the plastic liner. A detailed study comparing metallic and plastic liners, as well as differences among various plastics is given in @Su2021. 
Key findings include that metals, with their higher density, exhibit better resistance to H#sub[2] diffusion. However, metals are heavier and more susceptible to embrittlement. The choice of plastic and the use of special effects, such as the tortuous effect (achieved by adding fillers), can significantly influence diffusion behavior. The primary objective in liner design is to minimize H#sub[2]  diffusion, thereby achieving the lowest possible diffusion rate.
...
The four common tank types currently available in the commercial market are illustrated in @fig_4. This figure depicts a visual representation of the technological progression elaborated, showcasing the structural differences between each tank type and their respective materials.
...
It is important to note that, contrary to the labeling in @fig_4, tank types are conventionally designated using Roman numerals (I, II, III, IV) in literature @Wang2021b @Jella2024 @Cheng2024 @Rivard2019. At the time of writing this thesis, the Type V tank had also been developed @Air2023 @Air2023a. This latest iteration marks a notable advancement in pressure vessel technology, although it comes with certain trade-offs.
The Type V tank is characterized by its composition, consisting exclusively of #gls("cfrp", long:true) @Kassapoglou2013 @Rossow_2014 @Schuermann2007 @Mittelstedt2021 @Mittelstedt2022 @Hans_Bargel_2022 without a liner @Su2021. This design offers an influential weight reduction, with Type V tanks weighing approximately 20% less than their Type IV counterparts @Su2021. 
...
Type I tanks are made of metal only @Su2021, with common materials including steel and aluminum alloys.
Because such tanks are the easiest to manufacture among the five Types, they are generally the cheapest variant @Cheng2024 @khzouz2020hydrogen.
...
The study by @Cheng2024 compared Type III tanks at 300 and 700 bar with a Type IV tank at 700 bar. 
Some of the important findings are visualized in @fig_12.
...
Still, the Type III tank at 350 bar is cheaper than the 700 bar Type IV tank.
...
of the Type IV-a, where the appendix #emp_[a] was internally used to differentiate between two different Type IV configurations.  
The cited reason for this outcome was that the tank Type III incurred higher
...
These resources convey this information through a clear, structured tabular format, but lack additional information.
This is problematic, as it is not clear which costs constitute the figures 700 \$/kg and 633 \$/kg.
These could include costs such as raw material, liner material, energy, labor, and other manufacturing costs.
The aforementioned publications refer to @Rivard2019, and in this source itself, the provided link points to a 404 error message or file not found.
A manual search for the document based on its title and authors identified one report with a similar name and the same first two authors from 2013 @Law2013, but this was not the required document.
...
While @Shin2023 includes these \$/kg cost figures as well, it also presents a literature review on the prices of hydrogen storage tanks that range from around \$500 to \$3600.
To underscore the scientific need for cost modeling, @Shin2023 additionally outlines another literature review on this topic.
To highlight the importance of liner material selection for Type IV tanks, @tab_16 can be viewed.
...
It is crucial to note that even if simplified statements like 633 \$/kg were backed up with all the necessary contextual information, some additional important aspects still need to be evaluated.
The relationship between required tank mass and desired pressure is not linear, as shown with experimental tests @KubilayKarayel2023.
...
This includes personal vehicles, electronic devices such as laptops and smartphones, military applications, and toys.

It has been demonstrated that tank Types I and II are heavier than Types III to V. 
...
Consequently, the remaining lighter Types III to V are more favorable for mobile applications like in the automotive or aerospace sectors.
...
Moreover, the documented instances in @tab_17 suggest that tank Type IV has the highest application rate for personal vehicles.
...
Next, a comparison between Type V and IV tanks shall be made to provide insight into which should be used and when. First, it can be said that the costs of Type V are higher than Type IV. Secondly, as of writing this thesis, the availability of Type V tanks is very scarce.
The advantages of Type V over Type IV are that Type V is said to be 20% lighter @Su2021 and allows pressures up to 1000 bar @Cheng2024. 
Since the #gls("swith") is an aircraft, lightweight structures are highly desired. 
At first glance, the higher pressure would allow higher compression rates and thus enable more hydrogen storage. 
As a result, longer flight ranges could be achieved, demonstrating the promising potential of this solution
However, careful consideration reveals that higher working pressure requires more effort to be put into safety aspects @Yanxing2019 @Klell2023 @Zheng2012. 
Moreover, for #glspl("swith"), besides the internal pressure, additional external loads must also be withstood to ensure safe operation.


The pursuit of developing a #gls("swith") is a pioneering project. 
Combining it with Type V tanks could lead to undesired safety concerns, as these tanks are not yet widely adopted commercially and still need 
development to demonstrate maturity @Air2023 @Air2023a.
Given the innovative nature of #glspl("swith"), it is prudent to avoid combining it with other non-mature technologies. Instead, Type IV vessels, which are more mature and actively used in commercial applications, present a safer option under current conditions @Air2023.
Consequently, as of writing this thesis, #glspl("swith") should be operated with Type IV tanks. 
However, once Type V tank development has advanced sufficiently, safe utilization of their potential benefits can be expected, and #glspl("swith") can transition from Type IV to Type V tanks.
