...
While conformable pressure vessels can assume various shapes, a demonstrative example is depicted in @fig_10.
...
These resources convey this information through a clear, structured tabular format, but lack additional valuable information.
...
The mentioned literature refers to @Rivard2019, and in this source itself, a link is appears that points to a 404 error message or file not found. 
...
While @Shin2023 provided the explained \$/kg costs, it also presents a literature review on the prices of hydrogen storage tanks that range from around \$500 to \$3600.
To underscore the scientific need for cost modeling, @Shin2023 additionally outlines a literature review on this topic.
