...
This $bold(kappa)^(n_y times 2)$ representation is the desired outcome as it enables straightforward interpretation through two-dimensional plotting and provides the advantages discussed at the beginning of this subsection.
