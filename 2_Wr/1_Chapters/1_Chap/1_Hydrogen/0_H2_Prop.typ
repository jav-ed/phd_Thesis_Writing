...
=== II.9 Introductory Properties of Hydrogen
...
1) The smallest known atom is the hydrogen atom (H, diameter of 0.07 nm [12]).
...
4) H2 forms a stable bond, which means that both valence electrons are filled and thus show low reactivity.
   In general, the ability to attract electrons from other elements and thus initiate a chemical bond is described by electronegativity. This is lower for H2 than for most other elements (electronegativity of H2 = 2.2 [12]).
5) Odorless
6) Tasteless
7) Invisible
8) Non-toxic
...
10) Not radioactive
11) Not corrosive
12) Regenerative hydrogen production possible through water, wind or solar power plants. Regenerative production is feasible without competing with food production (occupation of cultivation area) as is known from plant-based biofuels [13].
13) Joule-Thompson coefficient negative at high pressures. This means a positive pressure change produces a negative temperature change and vice versa. When the pressure is increased, this is shown in the form of temperature decrease. The values are only a few Kelvin (about 5-15 Kelvin) even at high pressure changes.
    μJT = δT/δp
    For ideal gases, the Joule-Thompson coefficient = 0 [12].
...
15) Hydrogen is the element with the lowest density and is about 14 times lighter than air, although pressure and temperature influence this statement. [12].
...
18) Most fossil fuels consist of carbon and hydrogen: Methane CH4, Methanol CH3OH, Ethene C2H, Propane C3H8, Benzene C6H6 [12].
