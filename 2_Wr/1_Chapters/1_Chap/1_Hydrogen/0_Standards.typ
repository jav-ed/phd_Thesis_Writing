...
In summary, it can be said that within this work, it is not possible to rely exclusively on a single standard. Therefore, existing standards that show visible relevance for SIHFTs must be found. This is to provide a basis for follow-up work.