...
At this point, it should be explicitly mentioned again that at the time of writing this report, no single document exists that guarantees Germany-wide recognized standards for the approval of SIHFTs. Nevertheless, in order to build on existing knowledge through standards, similar or sub-areas of SIHFTs should be considered. For small aircraft certification, there is the CS-23 recognized in Europe. Compared to CS-25, which is intended for regular commercial aircraft, it comes with significantly fewer restrictions. Fewer restrictions also means fewer topics that are addressed and discussed. High standard detailing could offer valuable advantages, especially in terms of safety aspects. Furthermore, concrete ideas for conducting a structural test could also be given, for example, to answer the following questions:
