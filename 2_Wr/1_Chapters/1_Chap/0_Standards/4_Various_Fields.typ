...
Moreover, the temperature changes with flight altitude, ranging from $15 space degree.c upright("to") hyph.minus 50 space degree.c $ ($288.15 upright("K ") upright("to")  233.15 upright("K ") $)
for an altitude from $0  upright("km") upright("to") 10  upright("km") $
cruise altitude. According to @Rossow_2014, the maximal flight height is around $10 upright("km") upright("to") 13 upright("km")$, and according to @Filippone2010, most commercial airliners and business jets have final cruise altitudes well beyond $12 upright("km") ( approx 40,000 upright("ft"))$. From $0 upright("km") upright("to") 11 upright("km")$, the altitude range is called the troposphere, where the temperature drops from $288.15 upright("K ") upright("to")  216.65 upright("K ")$ ($15 degree.c upright("to")  hyph.minus 56.5 degree.c$).
