...
From $11 "km to" 20 "km"$, the stratosphere is reached, where no difference in temperature is observed. As the temperature remains constant between $11 "km" upright(" and") 13 "km"$, it can be said that aircraft need to withstand temperatures between $288.15 "K "$ ($15 " " degree.c$) and $216.65 "K "$ ($hyph.minus 56.5 degree.c$), as well as variations within this range.
