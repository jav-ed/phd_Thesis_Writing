...
Furthermore, $q_a$ from @eq_74 represents a force distributed over a length, or a line load.

// dot is used because it makes the distinction between the variables much easier -> easier than just adding some space.med
$ F_a = rho/2 dot u² dot C_l  dot c dot l space.quad  [#unit("N")] $ <eq_73>
$ q_a = rho/2 dot u² dot C_l  dot c  space.quad [#unit("N/mm")] $ <eq_74>
...
Since we obtained $q_a$ according to @eq_74, the length in chord direction has already been used. 
