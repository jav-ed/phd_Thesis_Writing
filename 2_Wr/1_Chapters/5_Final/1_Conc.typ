...
To apply physical loads to the wing of a #gls("swith"), #glspl("lie", long:true) were thoroughly explained and assessed. An optimization framework was developed to discretize the aerodynamic loads through #glspl("lie"). This framework provides important insights regarding the #glspl("lie") configuration, including their quantity, dimensions, and the magnitude of forces to be applied.
