...
The concept represents a significant departure from conventional aircraft design by integrating hydrogen fuel storage directly into the wing structure, where tanks not only store the fuel but also actively participate in load sharing. 
...
Due to the risk of ignition and potential detonation, the security-related features of hydrogen were investigated extensively. The research identified key factors for preventing hydrogen ignition. 
