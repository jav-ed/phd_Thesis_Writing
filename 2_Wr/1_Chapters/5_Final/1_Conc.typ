...
// -------------------------------------------------------------------------- //
The research was driven by the pressing need for environmental sustainability in aviation alongside the promise of hydrogen as an alternative fuel. At the time of writing, no operational #glspl("swith") existed in commercial aviation. The field lacked established standards or regulatory frameworks that could be leveraged for development and certification. While standards existed for various aspects of hydrogen storage and aircraft structures independently, none adequately addressed the unique challenges of integrating pressurized hydrogen tanks into aircraft wing structures.
Scientific literature addressing #glspl("swith") remained notably scarce, with no comprehensive studies available on their design or structural testing methodologies. These knowledge gaps emphasized both the novelty and necessity of this research.

This research established foundational steps toward certification of #glspl("swith") by developing methodologies for static testing, a critical component of experimental structural validation.
// -------------------------------------------------------------------------- //
The investigation revealed numerous existing standards and regulations in the field. However, none of these comprehensively addresses the unique properties associated with #glspl("swith"). Based on specific assessment criteria, four essential standards were identified as particularly relevant. These standards represent the current state of the art and provide valuable insights not only for the development of #glspl("swith") but also for understanding potential certification testing requirements.
A significant finding from the analysis concerns practical constraints related to testing capabilities. Current test facility limitations establish maximum allowable nominal pressure ranges between 437.5 and $525 "bar"$.
The investigation provided an extensive analysis of pressure vessel technology. The study examined hydrogen pressure vessel applications across various mobility sectors. 
...
Since hydrogen represents one of the main novelties in #glspl("swith"), understanding its properties was essential to this research. The investigation explored hydrogen's highly positive properties while acknowledging its associated challenges. Due to the risk of ignition and potential detonation, the security-related features of hydrogen were investigated extensively. The research identified key factors for preventing hydrogen ignition. For practical applications of #glspl("swith") at the scale of large aircraft, a detailed pathway was proposed, incorporating both experimental tests and numerical simulations.

The investigation revealed that current state-of-the-art technology for experimental testing of #glspl("swith") lacks the necessary advancement to ensure safe conditions for both the test article and surrounding hardware, as well as personnel. Consequently, substantial effort was devoted to examining whether hydrogen could be substituted with an alternative filling agent during experimental testing. To address this question, a curvature study approach was developed. Given the complexity of aircraft structures, the research provided examples for interpreting the results of this developed method.
To apply physical loads to the wing of a #gls("swith"), #glspl("lie") were thoroughly explained and assessed. An optimization framework was developed to discretize the aerodynamic loads through #glspl("lie"). This framework provides important insights regarding the #glspl("lie") configuration, including their quantity, dimensions, and the magnitude of forces to be applied.
...
To support this development, the establishment of an open-source #gls("fem")-based model for #gls("swith") could facilitate collaborative research efforts in this field.
