...
The concept represents a significant departure from conventional aircraft design by integrating hydrogen fuel storage directly into the wing structure, where the tanks not only store fuel but also actively participate in load sharing.
...
// -------------------------------------------------------------------------- //
The research was driven by the pressing need for environmental sustainability in aviation alongside the promise of hydrogen as an alternative fuel. At the time of writing, no operational #gls("swith") existed in commercial aviation. The field lacked established standards or regulatory frameworks that could be leveraged for development and certification. While standards existed for various aspects of hydrogen storage and aircraft structures independently, none adequately addressed the unique obstacles of integrating pressurized hydrogen tanks into aircraft wing structures.
Scientific literature concerning #glspl("swith") remained notably scarce, with no comprehensive studies available on their design or structural testing methodologies. These knowledge gaps emphasized the novelty and necessity of this research.
This research established foundational steps toward the certification of #glspl("swith") by developing methodologies for static testing, a critical component of experimental structural validation testing.

// -------------------------------------------------------------------------- //
The investigation revealed numerous existing standards and regulations in the field. However, none of these adequately addressed the unique properties associated with #glspl("swith"). Based on specific assessment criteria, four essential standards were identified as particularly relevant. These standards represent the current state of the art and provide valuable insights not only for the development of #glspl("swith") but also for understanding potential certification testing requirements.
...
An extensive analysis of pressure vessel technology was conducted in this study, including hydrogen pressure vessel applications across various mobility sectors. 


Based on this analysis, Type IV vessels emerged as the most suitable configuration for #glspl("swith") at present.
...
The investigation explored hydrogen's highly positive properties while acknowledging its associated challenges. 
Due to the risk of ignition and potential detonation, the safety-related features of hydrogen were investigated extensively. The research identified key factors for preventing hydrogen ignition. 
Subsequently, for practical applications of #glspl("swith") at the scale of large aircraft, a detailed pathway was proposed, incorporating both experimental tests and numerical simulations.

The investigation revealed that current state-of-the-art experimental testing technology for #glspl("swith") is not yet advanced enough to ensure safe conditions for both the test article and surrounding hardware, as well as personnel. 
Consequently, substantial effort was devoted to examining whether hydrogen could be substituted with an alternative filling agent during experimental testing. 
To address this question, a curvature study approach was developed. 
Given the complexity of aircraft structural geometries, the research provided examples for interpreting the results using the developed method.
...
To support this development, the establishment of an open-source #gls("fem", long:true) model of a #gls("swith") could facilitate collaborative research efforts in this field.

A fundamental question that requires investigation is whether the practical #glspl("swith") demonstrate superior performance compared to conventional aircraft designs, where hydrogen tanks are simply incorporated into the existing structure.
