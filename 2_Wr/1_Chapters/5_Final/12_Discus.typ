...
// the general optimiaztion framework was elucidated in @chap_4_4, it can be used for #gls("ld"). 
Building upon the optimization framework established in @chap_4_4, @chap_4_5_0 to @chap_4_5_3 demonstrate its practical application to #gls("ld"). This investigation presents a systematic optimization approach for #gls("ld"), establishing methodologies for determining optimal #gls("lie") configurations in structural testing applications. The strategic selection and placement of #glspl("lie") can significantly influence both testing quality and economic efficiency in static structural evaluation procedures.
