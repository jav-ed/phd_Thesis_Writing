...
This investigation can be divided into two complementary approaches: a theoretical foundation and a practical approach supported by numerical simulations and experimental elaboration. The current section focuses on the theoretical knowledge, while the subsequent @chap_2_0_2 complements it with practical insights derived from simulations and experiments.
...
The factors outlined in @tab_20 underscore the necessity for a comprehensive understanding of the medium used in #gls("swith") applications. For hydrogen specifically, the properties elaborated in @chap_1_0_6 are essential for conducting in-depth investigations into its unique characteristics.
...
The analysis thus far has elucidated two primary aspects. Firstly, considering this section in conjunction with the previous @chap_2_0_0 and forthcoming sections, it becomes evident that hydrogen possesses numerous unique properties warranting thorough examination. 
