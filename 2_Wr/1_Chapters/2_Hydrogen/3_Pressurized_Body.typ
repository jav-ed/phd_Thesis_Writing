...
The authors of @mitsuishi2000dynamic synthesize their results into three primary conclusions. Firstly, they observed that the effect of pressure force in high-pressure cylinders is contingent upon the direction of the external force applied. Specifically, lateral pressure forces in high-pressure cylinders generate higher loads compared to external axial pressure forces. Secondly, their examination revealed that when a pressure cylinder is subjected to an axial pressure force, tensile stresses manifest in the boundary region between the cylinder dome and its middle section. 
Lastly, and perhaps most significantly, the study found that cylinders tested under high-pressure conditions exhibited pressure loads exceeding those typically assumed in vehicle crash test procedures.


Numerical modeling approaches have been employed to study the impact behavior of various tank types. Abaqus @Shen2023 @Barbero2023 simulations were employed to model both axial and lateral impacts on a Type III tank, consisting of an aluminum liner (6061-T6) and a #gls("cfrp", long:true) winding (T800/Epoxy with 65% fiber volume fraction), as reported by @perfetto2022numerical.
Upon comparison with experimental data, the study demonstrated that lateral impact simulations yielded more accurate results than axial impact models, with lateral impact simulations achieving acceptable quality. The correlation between experimental and numerical outcomes for the lateral impact scenario is presented in @fig_27.
