...
Subsequently, the findings will be presented. The section will conclude by synthesizing the findings from these investigations and drawing relevant conclusions for experimental structural validation tests for #glspl("swith"). 
...
The results depicted in @fig_24 reveal several key insights. Firstly, there is a clear correlation between increasing pressure in the hydrogen container and a higher probability of self-ignition. Conversely, at low pressure values, self-ignition could be avoided across all investigated gas environments. This finding is particularly significant, as preventing unwanted hydrogen ignitions is considered a paramount safety criterion for practical hydrogen applications.
