...
After examining the dynamic loading aspects, the analysis conducted in @chap_3_0 established the vertical gust load as the critical static test load for this thesis. 
...
// --------------------------------- summary -------------------------------- //
#summary_([
In summary, the investigation of fill media effects on pressurized structures has revealed several critical findings. 
