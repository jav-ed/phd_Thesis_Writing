...
The first approach involves conducting experimental tests during actual flight conditions. However, this option presents substantial challenges for the current aircraft concept, including numerous technical uncertainties and potentially catastrophic safety risks. 
...
Even with the implementation of robust safety measures and successful pressurization protocols for the tanks, substantial technical challenges persist regarding instrumentation. The high-velocity environment poses two critical concerns: potential degradation of measurement accuracy and the risk of instrument detachment under aerodynamic loading.
