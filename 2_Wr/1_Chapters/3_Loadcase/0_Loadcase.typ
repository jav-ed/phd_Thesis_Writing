...
The practical implications of these calculation demands are substantial. A DNS study conducted on Argonne's Mira supercomputer demonstrates these resource requirements. The investigation required 25 million core hours, while comparable WMLES cases averaged only 150,000 core hours on the same system, revealing DNS to be approximately 150 times more compute intensive than WMLES @Fu2020. Direct numerical simulations face significant scalability barriers. Despite their foundation in fundamental physics laws and equations of motion, these simulations remain technically infeasible at scales necessary for critical applications such as climate and weather modeling @Kochkov2021.
