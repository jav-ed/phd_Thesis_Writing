...
This subsection examines the direct, demonstrable contributions of this research work. It begins by reiterating the primary objective driving the development of #glspl("swith"). Subsequently, it details other concrete advantages that this thesis offers. 
...
In response to this gap, the research identifies alternative solutions and explicitly addresses their limitations. 
...
Continuing in @chap_3_1 to @chap_3_3 this work address another critical question for the experimental structural testing of #glspl("swith").
...
A more efficient approach involves systematically evaluating multiple configurations. 
...
Despite their extensive experience in structural testing, IMA incorporated the findings, analyses, and optimization framework presented here into their testing methodology for a #gls("swith"). 
...
As the public becomes more aware of and invested in such cutting-edge research, it may lead to a more scientifically literate society, better equipped to address complex global challenges.

In conclusion, while the primary objective of this thesis is to advance specific aspects of #gls("swith") research, it is part of a broader scientific endeavor with potentially far-reaching implications. 
It is crucial to consider that the realization of these indirect benefits requires continued investment, further research, and successful implementation beyond the scope of this work. As subsequent chapters delve deeper into the technical aspects of #glspl("swith"), readers should view these potential broader impacts as aspirational goals that may guide future research directions rather than guaranteed outcomes of this specific thesis.
