...
/* -------------------------------- hydrogen -------------------------------- */
Given the indispensable role of hydrogen in #glspl("swith"), a comprehensive introduction to hydrogen and its properties is essential to this research. 
...
This research aims to design and examine potential experimental setups based on the critical load cases identified earlier, with the goal of maximizing the relevance of these experiments to certification institutions. 
These experimental investigations can be pivotal in demonstrating the viability and safety of #glspl("swith") to regulatory bodies. 
Furthermore, the study needs to explore whether certain hazardous properties of hydrogen can be safely disregarded in experimental structural verification of #glspl("swith") without compromising the integrity or validity of the tests. 
