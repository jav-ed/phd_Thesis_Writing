...
Firstly, the safety profile of potential alternative agents needs to be assessed, taking into account any properties that could pose risks to personnel, the environment, or the #gls("swith") structure itself. 
...
This approach is supposed to provide a solid foundation for understanding the consequences of using alternative filling agents in experimental investigations in #glspl("swith") and their potential impact on the overall performance and safety of the system.
...
This study should investigate various options available for physically applying forces to the #gls("swith") within a potential structure verification process. A comprehensive exploration of load transfer methods needs to be conducted, identifying a range of techniques that could be employed in experimental settings. 
...
Based on this evaluation, if feasible, a preferred method for physically introducing forces into the #gls("swith") should be recommended. This recommendation needs to be well-justified, taking into account the strengths and limitations of each approach in the context of #glspl("swith") structural verification. 
...
For the certification of #glspl("swith"), one part is to conduct an experimental structural validation test.
