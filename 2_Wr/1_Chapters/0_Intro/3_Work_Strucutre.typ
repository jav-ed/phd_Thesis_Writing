...
The integration of beam modeling within the optimization workflow is presented in @chap_4_4.
...
The optimization framework is subsequently applied to obtain multiple solutions that reflect real-world efforts undertaken for static experimental structural validation testing. @chap_4_5_0 to @chap_4_5_3 present the complete modeling rationale and results.
